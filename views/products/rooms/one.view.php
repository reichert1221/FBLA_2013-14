    <div class="container">
      ...
      <div class="center">
        <h1>One Night Stay</h1>
        <p class="lead">Getting just a taste?</p>
    </div>
    ...
    <div class="col-md-6">
    	...
    	<form role="form" action="/reserve/room/onenight" method="POST">
		  ...
		  <!--<p><a class="btn btn-default btn-md" href="/reserve/room/onenight">Make Reservation</a></p>-->
