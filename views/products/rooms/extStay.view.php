    <div class="container">
      ...
      <div class="center">
        <h1>Extended Stay</h1>
        <p class="lead">Why just stay a couple of days?</p>
    </div>
    ...
    <div class="col-md-6">
    	...
    	<form role="form" action="/reserve/room/multinight" method="POST">
		  ...
		  <!--<p><a class="btn btn-default btn-md" href="/reserve/room/multinight">Make Reservation</a></p>	-->
